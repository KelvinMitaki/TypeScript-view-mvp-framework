...
/** @class */
function () {
  function Model(attributes, event, sync) {
  ...
  Model.prototype.save = function () {
    ...
    var attr = this.attributes.getAll();
    this.sync.save(attr).then(function (res) {
...
function () {
  function Collection(rootUrl, deserialize) {
    ...
    this.models = [];
    this.event = new Eventing_1.Eventing();
  }
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts","./Attributes":"src/models/Attributes.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var User_1 = require("./models/User"); // const user = User.buildUser({ name: "Last User", age: 30 });
